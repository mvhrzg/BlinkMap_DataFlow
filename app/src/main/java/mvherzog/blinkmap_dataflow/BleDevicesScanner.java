...
//                    {
//                        if (mServicesToDiscover == null || !Collections.disjoint(parseUuids(scanRecord), mServicesToDiscover))
//                        {       // only process the devices with uuids in mServicesToDiscover
...
//    };
//
//    public BleDevicesScanner(BluetoothAdapter adapter, BluetoothLeScanner scanner, UUID[] servicesToDiscover, BluetoothAdapter.LeScanCallback callback)
//    {
//        Log.d(TAG, "bd constructor");
