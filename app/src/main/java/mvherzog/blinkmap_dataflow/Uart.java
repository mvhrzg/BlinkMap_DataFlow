...
public class Uart extends BluetoothGattCallback implements BluetoothAdapter.LeScanCallback
{
    ...
    public void send(byte[] data)
    {
        ...
        writeLine("Writing [tx] characteristic: ", tx.getStringValue(0));
        gatt.writeCharacteristic(tx);
        // ToDo: Update to include a timeout in case this goes into the weeds
        while (writeInProgress)
        {
            writeLine("[tx] Characteristic write in progress");
    ...
    public void onConnectionStateChange(BluetoothGatt gatt, int status, int newState)
    {
        ...
        Log.i("onConnStateChanged", String.format("Status: %d, newState: %d", status, newState));
    ...
    public void onCharacteristicRead(BluetoothGatt gatt, BluetoothGattCharacteristic characteristic, int status)
    {
        ...
        if (status == BluetoothGatt.GATT_SUCCESS)
        {
            writeLine("onCharacteristicRead!: " + characteristic.getUuid(), characteristic.getStringValue(0));
    ...
    public void onCharacteristicWrite(BluetoothGatt gatt, BluetoothGattCharacteristic characteristic, int status)
    {
        ...
        if (status == BluetoothGatt.GATT_SUCCESS)
        {
            writeLine("Characteristic write successful", characteristic.getStringValue(0));
        }
    ...
    private void writeLine(final String prompt, Object text)
    {
        if (text instanceof Integer)
        {
            Log.v("Uart int", String.format(prompt + ": %d", text));
        }
        else
        {

            Log.v("Uart string", String.format(prompt + ": %s", text));
        }
    }

    private void writeLine(final Object prompt)
    {
        if (prompt instanceof Integer)
        {
            Log.v("Uart int", String.valueOf(prompt));
        }
        else
        {
            Log.v("Uart string", String.valueOf(prompt));
        }
    }
}
...
//public class Uart extends BluetoothGattCallback
//{
//    // Log
//    private final static String TAG = Uart.class.getSimpleName();
//
//    // Constants
...
//    }
//
//    private Uart.ServiceAction serviceReadAction(final BluetoothGattService gattService, final String characteristicUuidString, final String descriptorUuidString)
//    {
//        return new Uart.ServiceAction()
//        {
//            @Override
//            public boolean execute(BluetoothGatt bluetoothGatt)
//            {
...
//    }
//
//    private Uart.ServiceAction serviceNotifyAction(final BluetoothGattService gattService, final String characteristicUuidString, final boolean enable)
//    {
//        return new Uart.ServiceAction()
//        {
//            @Override
...
//    }
//
//    private Uart.ServiceAction serviceIndicateAction(final BluetoothGattService gattService, final String characteristicUuidString, final boolean enable)
//    {
//        return new Uart.ServiceAction()
//        {
//            @Override
...
//    }
//
//    private Uart.ServiceAction serviceWriteAction(final BluetoothGattService gattService, final String uuid, final byte[] value)
//    {
//        return new Uart.ServiceAction()
//        {
//            @Override
...
//            {
//                final Uart.ServiceAction action = mQueue.pop();
...
//    protected static Uart createExecutor(final BleExecutorListener listener)
//    {
//        return new Uart()
//        {
//            @Override
